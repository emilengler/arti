...
pub enum Error {
    ...
    /// this with [`require_file`](crate::Mistrust::require_directory) and
    /// [`require_directory`](crate::Mistrust::require_directory).
    ///
    /// All ancestors of the target must be
    ...
    /// it by calling [`all_errors`](crate::Mistrust::all_errors).
    ///
