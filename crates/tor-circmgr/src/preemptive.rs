...
mod test {
    ...
    fn predicts_starting_ports() {
        let predictor = PreemptiveCircuitPredictor::new(vec![], 2);
        ...
        let predictor =
            PreemptiveCircuitPredictor::new(vec![TargetPort::ipv4(80), TargetPort::ipv6(80)], 2);
    ...
    fn predicts_used_ports() {
        let mut predictor = PreemptiveCircuitPredictor::new(vec![], 2);
