...
use tor_bytes_redux::FromBuf;
use tor_bytes_redux::unchecked::Buf;


/// The GenericArray type is defined to work around a limitation in Rust's
/// typesystem.
impl<T, N> Readabl for GenericArray<T, N>
where
    T: Readable + Clone,
...
impl<T, N> FromBuf for GenericArray<T,N> where T: FromBuf + Clone, N: generic_array::ArrayLength<T>
